        ...
        <div className="max-w-4xl mx-auto px-6 py-12">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8 text-center">
              Privacy Policy for AquaLingua
            </h1>
            
            <div className="prose prose-lg max-w-none text-gray-700">
              <div className="text-center mb-8">
                <p className="text-lg text-gray-600">
                  <strong>Last updated:</strong> August 03, 2025
                </p>
              </div>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4 mb-6">
                  ...
                  <li><strong>Application</strong> refers to AquaLingua, the software program provided by the Company.</li>
                  <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to AquaLingua.</li>
                  ...
                  <li><strong>Website</strong> refers to AquaLingua, accessible from aqualingua.app</li>
              ...
              <section className="mb-8">
                ...
                <p className="mb-4">
                  By email: <a href="mailto:info@aqualingua.app" className="text-blue-600 hover:text-blue-800 underline">info@aqualingua.app</a>
                </p>
